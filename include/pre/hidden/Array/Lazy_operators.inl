...
[[gnu::always_inline]] constexpr auto operator+(
    ...
    return LazyArray(
        [&](auto k) constexpr noexcept { return lhs(k) + rhs(k); }, lhs.sizes);
}
...
[[gnu::always_inline]] constexpr auto operator+(
    ...
    return LazyArray(
        [&](auto k) constexpr noexcept { return lhs(k) + rhs; }, lhs.sizes);
}
...
[[gnu::always_inline]] constexpr auto operator+(
    ...
    return LazyArray(
        [&](auto k) constexpr noexcept { return lhs + rhs(k); }, rhs.sizes);
}
